...
@section('title')
    <title>Eshoper | Admin Home - Create Product</title>
@endsection
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            <label>Color</label>
            <input type="text" name="color" placeholder="Color" class="form-control border-primary border-2" value="{{old('color')}}">
          </div>
          @error('color')
            <p class="text-danger">{{$message}}</p>
          @enderror  
          ...
          <div class="col-md-6 mb-3">
            <label>Size*</label>
            <input type="text" name="size" placeholder="Size" class="form-control border-primary border-2" value="{{old('size')}}">
          </div>
          @error('size')
            <p class="text-danger">{{$message}}</p>
          @enderror
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="number" name="basePrice" placeholder="Base Price" class="form-control border-primary border-2" value="{{old('basePrice')}}">
          </div>
          @error('basePrice')
            <p class="text-danger">{{$message}}</p>
          @enderror
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" name="discount" placeholder="discount" class="form-control border-primary border-2" value="{{old('discount')}}">
          </div>
          @error('discount')
            <p class="text-danger">{{$message}}</p>
          @enderror
              ...
              <input type="hidden" name="description" id="description" value="{{old('description')}}">
               <textarea name="description" rows="5" class="form-control border-primary border-2" placeholder="Description" value="{{old('description')}}" ></textarea>
               </div>
           ...
           <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="number" name="Stock_Quantity" placeholder="Enter StockQuantity" value="{{old('Stock_Quantity')}}" class="form-control border-primary border-2">
